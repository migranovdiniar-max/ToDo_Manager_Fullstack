...
Задача проекта — небольшое веб‑приложение с авторизацией и CRUD‑операциями над связанными сущностями.

FastAPI + PostgreSQL дают надёжный и понятный backend для такого рода задач.
